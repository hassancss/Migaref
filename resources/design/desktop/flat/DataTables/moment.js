...
(function (a) {
  ...
  for (
    var tb,
      ...
      Hb = {},
      Ib = [],
      Jb = "undefined" != typeof module && module && module.exports,
      Kb = /^\/?Date\((\-?\d+)/i,
      Lb = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,
      Mb =
      ...
      isAfter: function (a, b) {
        ...
        return (
          ...
          "millisecond" === b
            ...
            : ((c = tb.isMoment(a) ? +a : +tb(a)), c < +this.clone().startOf(b))
        );
      },
      isBefore: function (a, b) {
        ...
        return (
          ...
          "millisecond" === b
            ...
            : ((c = tb.isMoment(a) ? +a : +tb(a)), +this.clone().endOf(b) < c)
        );
      },
      isSame: function (a, b) {
        var c;
